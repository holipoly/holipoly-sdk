...
export type AccountAddressCreate = {
  ...
  user: Maybe<User>;
  /** @deprecated Use errors field instead. This field will be removed in Holipoly 4.0. */
...
export type AppTypeEnum =
  /** Local Holipoly App. The app is fully manageable from dashboard. You can change assigned permissions, add webhooks, or authentication token */
  | 'LOCAL'
  /** Third party external App. Installation is fully automated. Holipoly uses a defined App manifest to gather all required information. */
  | 'THIRDPARTY';
...
export type AttributeTranslatableContent = Node & {
   ...
   * @deprecated Will be removed in Holipoly 4.0. Get model fields from the root level.
   */
  attribute: Maybe<Attribute>;
};
...
export type Category = Node & ObjectWithMetadata & {
   ...
   * @deprecated Will be removed in Holipoly 4.0. Use the `description` field instead.
   */
...
export type CheckoutCreate = {
  /** Whether the checkout was created or the current active one was returned. Refer to checkoutLinesAdd and checkoutLinesUpdate to merge a cart with an active checkout.DEPRECATED: Will be removed in Holipoly 4.0. Always returns True. */
...
export type Order = Node & ObjectWithMetadata & {
  ...
  isShippingRequired: Scalars['Boolean'];
  /** @deprecated Use the `languageCodeEnum` field to fetch the language code. This field will be removed in Holipoly 4.0. */
  languageCode: Scalars['String'];
  /** Order language code. */
  languageCodeEnum: LanguageCodeEnum;
  /**
   * Returns applied discount.
   * @deprecated Use discounts field. This field will be removed in Holipoly 4.0.
   */
  discount: Maybe<Money>;
  /**
   * Discount name.
...
export type OrderRefundProductsInput = {
  ...
  /** If true, Holipoly will refund shipping costs. If amountToRefund is providedincludeShippingCosts will be ignored. */
...
export type OrderReturnProductsInput = {
  ...
  /** If true, Holipoly will refund shipping costs. If amountToRefund is providedincludeShippingCosts will be ignored. */
  includeShippingCosts?: Maybe<Scalars['Boolean']>;
  /** If true, Holipoly will call refund action for all lines. */
...
export type Page = Node & ObjectWithMetadata & {
   ...
   * @deprecated Will be removed in Holipoly 4.0. Use the `content` field instead.
   */
...
export type Product = Node & ObjectWithMetadata & {
   ...
   * @deprecated Will be removed in Holipoly 4.0. Use the `mediaById` field instead.
   */
   ...
   * @deprecated Will be removed in Holipoly 4.0. Use the `media` field instead.
   */
...
export type ProductType = Node & ObjectWithMetadata & {
   ...
   * @deprecated Will be removed in Holipoly 4.0. Use the top-level `products` query with the `productTypes` filter.
   */
  products: Maybe<ProductCountableConnection>;
  /** A type of tax. Assigned by enabled tax gateway */
  taxType: Maybe<TaxType>;
...
export type ProductVariant = Node & ObjectWithMetadata & {
   ...
   * @deprecated Will be removed in Holipoly 4.0. Use the `media` instead.
   */
  images: Maybe<Array<Maybe<ProductImage>>>;
...
/** Represents a recipient of email notifications send by Holipoly, such as notifications about new orders. Notifications can be assigned to staff users or arbitrary email addresses. */
...
export type User = Node & ObjectWithMetadata & {
   ...
   * @deprecated Will be removed in Holipoly 4.0. Use the `checkout_tokens` field to fetch the user checkouts.
   */
  checkout: Maybe<Checkout>;
...
export type Warehouse = Node & ObjectWithMetadata & {
   ...
   * @deprecated Use address.CompanyName. This field will be removed in Holipoly 4.0.
   */
  companyName: Scalars['String'];
};
